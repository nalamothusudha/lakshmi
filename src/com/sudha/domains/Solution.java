...
public class Solution {
	...
	public String solution(String s) {
		...
		for(int i = 0; i < lines.length; i++) {
			list.add(Image.parsePhoto(lines[i]));
		}
		Map<String, List<Image>> cityMap = list
		        .stream()
		        .sorted(new PhotoCompareAndSorter())
	...
	public static class PhotoCompareAndSorter implements Comparator<Image>{
	...
	public static class Image {
		...
		public Image(String name, String ext, Date date, String city) {
			this.name = name;
			this.ext = ext;
			this.date = date;
			this.city = city;
		...
		public static Image parsePhoto(String s) {
			...
			return new Image(nameSplit[0], nameSplit[1], date, city);
		}
